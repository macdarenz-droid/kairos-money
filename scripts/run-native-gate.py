...
try:
    ...
    instrumentation('IntelligenceInstrumentedTest', 2)
    ...
    (EVIDENCE / 'native-run-status.json').write_text(json.dumps({
        ...
        'authentication_bound_key_tests': 1, 'pin_recovery_tests': 3, 'foundation_tests': 2, 'import_tests': 2, 'revision_tests': 2, 'intelligence_tests': 1, 'manual_entry_tests': 1, 'acceptance_tests': 1,
