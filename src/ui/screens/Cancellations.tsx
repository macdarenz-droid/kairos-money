...
export function Cancellations({code,merchants,payments=[],review}:{code:Currency;merchants:string[];payments?:{merchant:string;date:string;id:string}[];review?:(merchant:string,ids:string[])=>void}){
 ...
 return <section className="stack cancellation-records" aria-label="Cancellation records"><h3>Track a cancellation</h3><p className="meta">Contact the provider first. This records your progress; it does not cancel a service. Expected bills and forecasts stay conservative until you verify later statements. Records apply to this merchant in {code} across your accounts.</p>
