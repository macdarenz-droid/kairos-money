...
export function accountFreshness(accountId: string, batches: readonly BatchSummary[], today: string) {
...
export function newestIsStale(accountIds: string[], batches: readonly BatchSummary[], today: string) { return !accountIds.length || accountIds.every(id=>accountFreshness(id,batches,today).stale); }
