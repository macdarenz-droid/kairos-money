...
export function buildDocument(extracted: Extracted, sourceHash: string, fileName: string, context: ImportContext, opening: string, closing: string, payslip: boolean, mapping?: Columns, aliases: readonly { canonical: string; aliases: string[] }[] = []): Document {
