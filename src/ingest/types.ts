...
export type NormalizedRow = { sourceId: string; accountId: string; date: string; description: string; merchant: string; minor: string; currency: Currency; reference: string; pending: boolean; status?: 'pending' | 'settled'; runningBalance?: string; confidence: number; fingerprint: string; issues: string[]; category: string | null; verified: boolean; duplicateOf: string | null; occurrence: string; createRule: boolean; mcc: string | null; categoryFrom?: 'suggestion' | 'ai' };
