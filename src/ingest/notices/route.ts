 ...
 * amount, a receipt number and a store number are all digits, and "WITHDRAWAL-OSKO PAYMENT 1826645" would
 * otherwise route money by its reference number. "ending 189", "acct ••6522", "card x1234" are claims
 ...
 *
 * Banks do not agree on how many digits to print — CommBank says "ending 189", others print all four — so
 * a three-digit tail is matched as a suffix of the stored mask rather than as an equal string. That is a
 * looser test, which is why an ambiguous answer is refused: if two accounts both end 189, the notice has
